...
class Rbac
{
    ...
    const PERMISSION_SHOP_EXTRA_STATUS_EDIT = 'permShopExtraStatusEdit';
    ...
    const PERMISSION_SHOP_MODIFICATION_GROUP_VIEW = 'permShopModificationGroupView';
    const PERMISSION_SHOP_MODIFICATION_GROUP_EDIT = 'permShopModificationGroupEdit';
    ...
    const PERMISSION_SHOP_DISCOUNT_EDIT = 'permShopDiscountEdit';
    const PERMISSION_SHOP_DISCOUNT_VIEW = 'permShopDiscountView';
