...
/**
 * Клас наследуется от стандартного поведения изображений и переопределяет некоторые его методы для
 * использования изображений на удаленном сервере по некоторому подключению через Flysystem
 * Class FlySystemImageUploadBehavior
